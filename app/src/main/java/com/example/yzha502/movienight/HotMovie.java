...
public class HotMovie extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            String res = new getHotMovies().execute(user.getUserEmail()).get();
    ...
    private class getHotMovies extends AsyncTask<String, Void, String> {

        protected String doInBackground(String... name) {

            //String result;
            return MovieWeb.getHotMovie();
        }
...
//                break;
    ...
    public void restoreActionBar() {
        mNavigationDrawerFragment.setUp(
                ...
                (DrawerLayout) findViewById(R.id.drawer_layout_hot));
