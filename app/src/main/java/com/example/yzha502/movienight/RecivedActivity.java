...
public class RecivedActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        eventList = (ListView) findViewById(R.id.get_Message_list);
    ...
    private class getSendedMessage extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... name) {
            ...
            //String result;
            return UserWeb.findReciver(name[0]);
        }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_recived, menu);
        return true;
    }
